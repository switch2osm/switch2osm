...
There’s no limit to what you can do with OpenStreetMap. Yet it needn’t take long to get started. You can switch to OSM in under an hour using tools like the easy [Leaflet API](http://leaflet.cloudmade.com/) and MapQuest Open’s [free tiles](http://developer.mapquest.com/web/products/open/map). Read the rest of this site to get started with the possibilities.