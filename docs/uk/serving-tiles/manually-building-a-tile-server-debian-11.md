...
dist: Debian 11
maintainers: супроводжувачами Debian
...
!!! info ""
    На цій сторінці міститься опис зі встановлення, розгортання та налаштування всього потрібного програмного забезпечення для роботи вашого тайлового сервера. Покрокові інструкції описують встановлення тайлового сервера на [Debian Linux](https://www.debian.org/){: target=_blank} 11 testing (bullseye), вони були перевірені у листопаді 2020.
...
Для того, щоб створити всі ці компоненти, вам спочатку треба встановити наступні залежності. Debian з типовими налаштуваннями не містить встановленої утиліти `sudo`, тож нам доведеться скористуватись правами користувача `root`, щоб додати її та інші потрібні нам компоненти:
